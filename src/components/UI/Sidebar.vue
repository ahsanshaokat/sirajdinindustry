      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          <li class="items-center">
            <a
              class="text-red-500 hover:text-red-600 text-xs uppercase py-3 font-bold block"
              href="/dashboard/home"
          ...
          <li class="items-center">
            <router-link to="/dashboard/products" class="text-grey-500 hover:text-red-600 text-xs uppercase py-3 font-bold block">
              <i class="fas fa-cart-shopping opacity-75 mr-2 text-sm"></i>
              Products
            </router-link>
          </li>
          <li class="items-center">
            <router-link to="/dashboard/users-list" class="text-grey-500 hover:text-red-600 text-xs uppercase py-3 font-bold block">
          ...
          <li class="items-center">
            <a
              class="text-grey-500 hover:text-red-600 text-xs uppercase py-3 font-bold block"
              href="#"
              @click="logout"
